...
# 微信小程序京东赚赚
6 0,1,2,11 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_jdzz.js |ts >> /scripts/logs/jd_jdzz.log 2>&1
# crazyJoy自动每日任务
...
# 必须要的默认定时任务请勿删除
17 11 * * * docker_entrypoint.sh |ts >> /scripts/logs/default_task.log 2>&1
