...
#京喜财富岛
5 1,11,22 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_cfd.js |ts >> /scripts/logs/jd_cfd.log 2>&1
...
# 必须要的默认定时任务请勿删除
41 11 * * * docker_entrypoint.sh |ts >> /scripts/logs/default_task.log 2>&1
